...
{	
	...
	public static void main(String[] args)
	{
		 ...
		 */
		int numTrials=10;
		//exec.runExperiment(new SimplePacmanBehavior(),new StarterGhosts(),numTrials);
		//exec.runExperiment(new PacmanMCTS(),new StarterGhosts(),numTrials);
		//exec.runExperiment(new PacmanStateMachine(),new StarterGhosts(),numTrials);
...
//		exec.runGameTimed(new NearestPillPacMan(),new AggressiveGhosts(),visual);
		...
		exec.runGameTimed(new SimplePacmanBehavior(), new StarterGhosts(), visual);
		//exec.runGameTimed(new PacmanStateMachine(), new StarterGhosts(), visual);
		//exec.runGameTimed(new PacmanMCTS(), new StarterGhosts(), visual);
//		exec.runGameTimed(new HumanController(new KeyBoardInput()),new StarterGhosts(),visual);	
     ...
     */
    public float runExperiment(Controller<MOVE> pacManController,Controller<EnumMap<GHOST,MOVE>> ghostController,int trials)
    {
    	double avgScore=0;
		...
		return (float)avgScore/(float)trials;
    }
